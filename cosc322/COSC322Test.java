   ...
   public static void main(String[] args) {				 
    ...
    public void ourMove(){
        ...
        for(move m : board.gameModel.childMoves){
            currentDepth.add(moveGenerator.getRoot().createChild(new BoardGameModel(moveGenerator.getRoot().getData(), m.qx, m.qy, m.nx, m.ny, m.ax, m.ay)));
        }
        ...
        while (ourTurn){
            ...
            for(ActionTree.Node<BoardGameModel> a : previousDepth){
                ...
                for(move m : currentBoard.childMoves){
                    ...
                    System.out.println("1" + m.ay);
                    currentDepth.add(a.createChild(new BoardGameModel(currentBoard, m.qx, m.qy, m.nx, m.ny, m.ax, m.ay)));
                }
	    ...
	    protected void paintComponent(Graphics gg){
		    ...
		    for(int r = 0; r < rows; r++){
		      for(int c = 0; c < cols; c++){
			    ...
			    else if(board[r][c].equalsIgnoreCase(
    ...
    public void determineMove(){
        ourTurn = false;
            ...
            BoardGameModel bestMove = moveGenerator.minMax();
            
            if(bestMove == null){
                System.out.println("RIP");
            }
            //System.out.println(bestMove.movedQueenPreviousX + bestMove.movedQueenPreviousY + bestMove.movedQueenNowX + bestMove.movedQueenNowY);
            //playerMove(bestMove.movedQueenPreviousX, bestMove.movedQueenPreviousY, bestMove.movedQueenNowX, bestMove.movedQueenNowY, bestMove.firedArrowX, bestMove.firedArrowY);
    }
