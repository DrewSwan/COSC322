...
public class COSC322Test extends GamePlayer{
   ...
   public static void main(String[] args) {				 
    ...
    public void ourMove(){
        ActionTree moveGenerator = new ActionTree(board.gameModel);
        PossibleMoves initialMove = new PossibleMoves(board.gameModel);
        ArrayList<move> generatedMoves = initialMove.moveGeneration();
        
        for(move a : generatedMoves){
            moveGenerator.getRoot().createChild(new BoardGameModel(moveGenerator.getRoot().getData(), a.qx, a.qy, a.nx, a.ny, a.ax, a.ay));
        }
