   ...
   public static void main(String[] args) {				 
    ...
    public void determineMove(int depth){
        ourTurn = false;
            ...
            System.out.println("PrevX " + (bestMove.movedQueenPreviousX + 1) + ",PrevY " + (bestMove.movedQueenPreviousY + 1) + ",NowX "+ (bestMove.movedQueenNowX + 1) + ",NowY " + (bestMove.movedQueenNowY + 1));
            playerMove(bestMove.movedQueenPreviousX + 1, bestMove.movedQueenPreviousY + 1, bestMove.movedQueenNowX + 1, bestMove.movedQueenNowY + 1, bestMove.firedArrowX + 1, bestMove.firedArrowY + 1);
    }
